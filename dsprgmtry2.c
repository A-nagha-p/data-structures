...
void main()
{
   ...
   {
      printf("\n MENU \n");
      printf(" 1. Insert 2. Display \n 3.Insert at End 4.Insert Between \n 5.Delete at end 6.Delete at beginning \n 7.Delete Between \n");
      ...
      scanf("%d", &value);
      printf("Enter the value to be location: ");
      scanf("%d", &loc);
...
int delete_loc(int loc)
{
   if(head==NULL)
    ...
    {
        printf("The node deleted %d and list is empty",temp->data);
        temp=temp->next;
        free(temp);
        return 0;
    }
